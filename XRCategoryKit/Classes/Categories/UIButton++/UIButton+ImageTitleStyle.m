...
-(void)addButtonSelectedStatus:(NSString *)title titleColor:(UIColor *)titleColor image:(UIImage *)image {
    if(title) [self setTitle:title forState:UIControlStateSelected];
    ...
    if(image) [self setImage:image forState:UIControlStateSelected|UIControlStateHighlighted];
}

-(void)addButtonSelectedStatus:(NSString *)title titleColor:(UIColor *)titleColor image:(UIImage *)image selectImage:(UIImage *)selectImage{
    if(title)       [self setTitle:title forState:UIControlStateSelected];
    if(titleColor)  [self setTitleColor:titleColor forState:UIControlStateSelected];
    if(image)       [self setBackgroundImage:image forState:UIControlStateNormal];
    if(image)       [self setBackgroundImage:image forState:UIControlStateHighlighted];
    if(selectImage) [self setBackgroundImage:selectImage forState:UIControlStateSelected];
    if(selectImage) [self setBackgroundImage:selectImage forState:UIControlStateSelected|UIControlStateHighlighted];
}
