...
-(void)addButtonSelectedStatus:(NSString *)title titleColor:(UIColor *)titleColor image:(UIImage *)image;

-(void)addButtonSelectedStatus:(NSString *)title titleColor:(UIColor *)titleColor image:(UIImage *)image selectImage:(UIImage *)image;
