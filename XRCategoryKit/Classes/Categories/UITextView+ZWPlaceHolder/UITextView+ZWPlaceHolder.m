...
-(UIFont *)zw_placeHolderFont{
    return self.zw_placeHolderLabel.font;
}

-(void)setZw_placeHolderFont:(UIFont *)zw_placeHolderFont{
    self.zw_placeHolderLabel.font = zw_placeHolderFont;
}
